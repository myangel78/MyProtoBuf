...
///
///
ProtocCodec::ProtocCodec()
{
}

std::string ProtocCodec::encode(const google::protobuf::Message& message)
{
  std::string result;
...
google::protobuf::Message* ProtocCodec::createMessage(const std::string& type_name)
{
...
int32_t ProtocCodec::asInt32(const char* buf)
{
  int32_t be32 = 0;
...
///
google::protobuf::Message* ProtocCodec::decode(const std::string& buf)
{
